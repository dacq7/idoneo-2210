...
//
//  1. **Un simulacro a medias.** El cronómetro **sigue corriendo** (Paso 11), así
//     que cualquier otra cosa que le ofrezcamos le está costando tiempo de examen.
//     Es lo único que gana al resto.
//  2. **El diagnóstico, si no lo ha hecho.** Es lo que convierte el plan genérico
//     en uno suyo, y cuanto antes lo haga, más días de plan aprovecha.
//  3. **Lo que toca hoy según el plan.** El plan ya resolvió el orden; repetir
//     aquí ese cálculo sería tener dos fuentes de verdad.
//  4. **La cola de repaso**, si hay algo vencido. Va antes que materia nueva:
//     lo que estás a punto de olvidar vale más que lo que aún no has visto.
//  5. **El siguiente módulo sin dominar.**
//  6. **Nada publicado todavía** — hoy, con 28 de 29 módulos en preparación,
