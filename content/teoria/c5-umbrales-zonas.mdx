...
<Ojo>
Los umbrales no son un interruptor. Son puntos de una curva continua. Presentarlos como rangos de porcentaje es una simplificación operativa, muy útil para prescribir, pero un deportista no "entra" en anaerobiosis al pasar del 84 % al 86 %.
</Ojo>
