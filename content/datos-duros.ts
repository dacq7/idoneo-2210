...
export const DATOS_DUROS: DatoDuro[] = [
  ...
  { id: 'DD-067', categoria: 'Biomarcadores', concepto: 'Proteína C reactiva ultrasensible (hs-PCR)', valor: 'menos de 1 mg/L riesgo bajo · 1–3 moderado · más de 3 alto', modulo: 'a5-sistemas-energeticos-biomarcadores' },
  ...
  { id: 'DD-070', categoria: 'Biomarcadores', concepto: 'Relación testosterona/cortisol', valor: 'Se vigila la CAÍDA respecto al basal del propio deportista: un descenso del 30 % o más señala sobrecarga. No hay valor absoluto universal — depende de las unidades', modulo: 'a5-sistemas-energeticos-biomarcadores' },
  { id: 'DD-071', categoria: 'Biomarcadores', concepto: 'IGF-1', valor: '100–300 ng/mL en adulto joven · desciende con la edad', modulo: 'a5-sistemas-energeticos-biomarcadores' },
  { id: 'DD-072', categoria: 'Biomarcadores', concepto: 'Ácido úrico', valor: '♂ 3,4–7,0 · ♀ 2,4–6,0 mg/dL', modulo: 'a5-sistemas-energeticos-biomarcadores' },
  ...
  { id: 'DD-083', categoria: 'Estadística', concepto: 'Varianza', valor: 'Poblacional Σ(x − x̄)² / n · muestral Σ(x − x̄)² / (n − 1)', modulo: 'a6-estadistica' },
